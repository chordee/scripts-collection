    ...
    def __init__(self, shadingGroups = None, scope = 'Looks', filename = None):
        ...
        self.translator = { 
            ...
            'RedshiftSkin':{
                ...
                'samples': {'name': 'samples', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                'include_mode': {'name': 'include_mode', 'type': Sdf.ValueTypeNames.Token, 'convert': IntToString},
                'shallow_color': {'name': 'shallow_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'refl_color0': {'name': 'refl_color0', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'refl_color1': {'name': 'refl_color1', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
            ...
            'RedshiftCarPaint':{
                ...
                'flake_color': {'name': 'flake_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'clearcoat_color': {'name': 'clearcoat_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'clearcoat_facingweight': {'name': 'clearcoat_facingweight', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'clearcoat_perpweight': {'name': 'clearcoat_perpweight', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'clearcoat_curvefactor': {'name': 'clearcoat_curvefactor', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'depth_override': {'name': 'depth_override', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                'refl_depth': {'name': 'refl_depth', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                'refl_enablecutoff': {'name': 'refl_enablecutoff', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                'refl_cutoff': {'name': 'refl_cutoff', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
            ...
            'RedshiftArchitectural':{
                ...
                'refr_trans_color': {'name': 'refr_trans_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'brdf_fresnel_lockIOR': {'name': 'brdf_fresnel_lockIOR', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                'brdf_fresnel_ior': {'name': 'brdf_fresnel_ior', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'brdf_fresnel_type': {'name': 'brdf_fresnel_type', 'type': Sdf.ValueTypeNames.Int, 'convert': IntToString},
                'brdf_extinction_coeff': {'name': 'brdf_extinction_coeff', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'brdf_0_degree_refl': {'name': 'brdf_0_degree_refl', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'brdf_90_degree_refl': {'name': 'brdf_90_degree_refl', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                ...
                'anisotropy_rotation': {'name': 'anisotropy_rotation', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'anisotropy_orientation': {'name': 'anisotropy_orientation', 'type': Sdf.ValueTypeNames.Int, 'convert': IntToString},
                'refl_base': {'name': 'refl_base', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'refl_base_color': {'name': 'refl_base_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'refl_base_gloss_samples': {'name': 'refl_base_gloss_samples', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                ...
                'brdf_base_fresnel_lockIOR': {'name': 'brdf_base_fresnel_lockIOR', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                'brdf_base_fresnel_ior': {'name': 'brdf_base_fresnel_ior', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'brdf_base_fresnel_type': {'name': 'brdf_base_fresnel_type', 'type': Sdf.ValueTypeNames.Int, 'convert': IntToString},
                'brdf_base_extinction_coeff': {'name': 'brdf_base_extinction_coeff', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'brdf_base_0_degree_refl': {'name': 'brdf_base_0_degree_refl', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'brdf_base_90_degree_refl': {'name': 'brdf_base_90_degree_refl', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                ...
                'do_refractive_caustics': {'name': 'do_refractive_caustics', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                ...
                'refr_falloff_color_on': {'name': 'refr_falloff_color_on', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                'refr_falloff_color': {'name': 'refr_falloff_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'ao_applyToIncandescence': {'name': 'ao_applyToIncandescence', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                'ao_compensateForExposure': {'name': 'ao_compensateForExposure', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
                ...
                'additional_color': {'name': 'additional_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
            ...
            'RedshiftMatteShadowCatcher':{
                ...
                'emissive_color': {'name': 'emissive_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
            ...
            'RedshiftHair':{
                ...
                'outColor': {'name': 'outColor', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                'irefl_color': {'name': 'irefl_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'diffuse_color': {'name': 'diffuse_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                'diffuse_weight': {'name': 'diffuse_weight', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'diffuseTrans_weight': {'name': 'diffuseTrans_weight', 'type': Sdf.ValueTypeNames.Float, 'convert': Same},
                'trans_color': {'name': 'trans_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
                ...
                'transp_color': {'name': 'transp_color', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
            ...
            'RedshiftIncandescent':{
                ...
                'applyExposureCompensation': {'name': 'applyExposureCompensation', 'type': Sdf.ValueTypeNames.Int, 'convert': Same},
            ...
            'RedshiftShaderSwitch':{
                ...
                'default_shader': {'name': 'default_shader', 'type': Sdf.ValueTypeNames.Color3f, 'convert': MayaArrayToVector},
